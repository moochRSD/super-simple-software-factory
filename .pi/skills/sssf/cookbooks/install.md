...
Stamp the entire factory out of the skill and into the current working directory by running the installer directly:
...
Run from the **target repo root** — the cwd is where everything lands. For this project, use `.pi/skills/sssf/scripts/install.py`.
